...
Pod::Spec.new do |s|
  s.name             = 'J2ObjCAuto'
  s.version          = '0.1.0'
  s.summary          = 'A short description of J2ObjCAuto.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yao_seu@126.com/J2ObjCAuto'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yao_seu@126.com' => 'hongbing.yao@byton.com' }
  s.source           = { :git => 'https://github.com/yao_seu@126.com/J2ObjCAuto.git', :tag => s.version.to_s }
