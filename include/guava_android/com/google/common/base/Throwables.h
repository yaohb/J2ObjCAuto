...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/base/Throwables.java
//
 ...
 */
+ (JavaLangRuntimeException *)propagateWithJavaLangThrowable:(JavaLangThrowable *)throwable __attribute__((deprecated));
...
+ (void)propagateIfInstanceOfWithJavaLangThrowable:(JavaLangThrowable *)throwable
                                      withIOSClass:(IOSClass *)declaredType __attribute__((deprecated));
...
@endcode
 */
+ (void)propagateIfPossibleWithJavaLangThrowable:(JavaLangThrowable *)throwable __attribute__((deprecated));
