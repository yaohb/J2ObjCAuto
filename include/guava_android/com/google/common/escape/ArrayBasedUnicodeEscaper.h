...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/escape/ArrayBasedUnicodeEscaper.java
//
 ...
 */
- (instancetype __nonnull)initWithComGoogleCommonEscapeArrayBasedEscaperMap:(ComGoogleCommonEscapeArrayBasedEscaperMap *)escaperMap
...
/*!
 ...
 @param unsafeReplacement the default replacement for unsafe characters or null if no default      replacement is required
 */
- (instancetype __nonnull)initWithJavaUtilMap:(id<JavaUtilMap>)replacementMap
                                      withInt:(jint)safeMin
                                      withInt:(jint)safeMax
                                 withNSString:(NSString *)unsafeReplacement;
