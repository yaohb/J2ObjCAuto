...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/RegularImmutableBiMap.java
//
 ...
 */
- (instancetype __nonnull)initWithNSObjectArray:(IOSObjectArray *)alternatingKeysAndValues
                                        withInt:(jint)size;
...
FOUNDATION_EXPORT void ComGoogleCommonCollectRegularImmutableBiMap_initWithNSObjectArray_withInt_(ComGoogleCommonCollectRegularImmutableBiMap *self, IOSObjectArray *alternatingKeysAndValues, jint size);

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableBiMap *new_ComGoogleCommonCollectRegularImmutableBiMap_initWithNSObjectArray_withInt_(IOSObjectArray *alternatingKeysAndValues, jint size) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableBiMap *create_ComGoogleCommonCollectRegularImmutableBiMap_initWithNSObjectArray_withInt_(IOSObjectArray *alternatingKeysAndValues, jint size);
