...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/RegularImmutableMap.java
//
...
/*!
 @brief Returns a hash table for the specified keys and values, and ensures that neither keys nor
  values are null.
 */
+ (IOSIntArray *)createHashTableWithNSObjectArray:(IOSObjectArray *)alternatingKeysAndValues
                                          withInt:(jint)n
...
+ (id)getWithIntArray:(IOSIntArray *)hashTable
    withNSObjectArray:(IOSObjectArray *)alternatingKeysAndValues
              withInt:(jint)size
              withInt:(jint)keyOffset
               withId:(id)key;
