...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/CompactLinkedHashSet.java
//
...
FOUNDATION_EXPORT void ComGoogleCommonCollectCompactLinkedHashSet_init(ComGoogleCommonCollectCompactLinkedHashSet *self);

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashSet *new_ComGoogleCommonCollectCompactLinkedHashSet_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashSet *create_ComGoogleCommonCollectCompactLinkedHashSet_init(void);

FOUNDATION_EXPORT void ComGoogleCommonCollectCompactLinkedHashSet_initWithInt_(ComGoogleCommonCollectCompactLinkedHashSet *self, jint expectedSize);

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashSet *new_ComGoogleCommonCollectCompactLinkedHashSet_initWithInt_(jint expectedSize) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashSet *create_ComGoogleCommonCollectCompactLinkedHashSet_initWithInt_(jint expectedSize);
