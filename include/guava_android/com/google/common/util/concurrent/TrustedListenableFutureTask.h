...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/util/concurrent/TrustedListenableFutureTask.java
//
...
- (instancetype __nonnull)initWithComGoogleCommonUtilConcurrentAsyncCallable:(id<ComGoogleCommonUtilConcurrentAsyncCallable>)callable;
...
FOUNDATION_EXPORT void ComGoogleCommonUtilConcurrentTrustedListenableFutureTask_initWithComGoogleCommonUtilConcurrentAsyncCallable_(ComGoogleCommonUtilConcurrentTrustedListenableFutureTask *self, id<ComGoogleCommonUtilConcurrentAsyncCallable> callable);

FOUNDATION_EXPORT ComGoogleCommonUtilConcurrentTrustedListenableFutureTask *new_ComGoogleCommonUtilConcurrentTrustedListenableFutureTask_initWithComGoogleCommonUtilConcurrentAsyncCallable_(id<ComGoogleCommonUtilConcurrentAsyncCallable> callable) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonUtilConcurrentTrustedListenableFutureTask *create_ComGoogleCommonUtilConcurrentTrustedListenableFutureTask_initWithComGoogleCommonUtilConcurrentAsyncCallable_(id<ComGoogleCommonUtilConcurrentAsyncCallable> callable);
