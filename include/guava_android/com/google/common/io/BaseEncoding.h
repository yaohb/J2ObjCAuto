...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/io/BaseEncoding.java
//
...
- (instancetype __nonnull)initWithComGoogleCommonIoBaseEncoding_Alphabet:(ComGoogleCommonIoBaseEncoding_Alphabet *)alphabet
...
- (instancetype __nonnull)initWithComGoogleCommonIoBaseEncoding_Alphabet:(ComGoogleCommonIoBaseEncoding_Alphabet *)arg0
...
- (instancetype __nonnull)initWithComGoogleCommonIoBaseEncoding:(ComGoogleCommonIoBaseEncoding *)delegate
                                                   withNSString:(NSString *)separator
                                                        withInt:(jint)afterEveryChars;
