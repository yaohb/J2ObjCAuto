...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/math/DoubleMath.java
//
 ...
 */
+ (jdouble)meanWithDoubleArray:(IOSDoubleArray *)values __attribute__((deprecated));
 ...
 */
+ (jdouble)meanWithIntArray:(IOSIntArray *)values __attribute__((deprecated));
...
/*!
 ...
 @throw IllegalArgumentExceptionif <code>values</code> is empty or contains any non-finite value
 */
+ (jdouble)meanWithJavaLangIterable:(id<JavaLangIterable>)values __attribute__((deprecated));
...
/*!
 ...
 @throw IllegalArgumentExceptionif <code>values</code> is empty or contains any non-finite value
 */
+ (jdouble)meanWithJavaUtilIterator:(id<JavaUtilIterator>)values __attribute__((deprecated));
...
/*!
 ...
 @throw IllegalArgumentExceptionif <code>values</code> is empty
 */
+ (jdouble)meanWithLongArray:(IOSLongArray *)values __attribute__((deprecated));
