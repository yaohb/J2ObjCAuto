...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/hash/AbstractStreamingHasher.java
//
...
/*!
 ...
 @param chunkSize the number of bytes available per <code>process(ByteBuffer)</code>  invocation;
       must be at least 4
 */
- (instancetype __nonnull)initWithInt:(jint)chunkSize;
...
FOUNDATION_EXPORT void ComGoogleCommonHashAbstractStreamingHasher_initWithInt_(ComGoogleCommonHashAbstractStreamingHasher *self, jint chunkSize);

FOUNDATION_EXPORT void ComGoogleCommonHashAbstractStreamingHasher_initWithInt_withInt_(ComGoogleCommonHashAbstractStreamingHasher *self, jint chunkSize, jint bufferSize);
