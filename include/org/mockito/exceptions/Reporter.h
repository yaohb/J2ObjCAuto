...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/testing/mockito/build_result/java/org/mockito/exceptions/Reporter.java
//
...
- (void)atMostAndNeverShouldNotBeUsedWithTimeout;

- (void)cannotCallAbstractRealMethod;
...
- (void)defaultAnswerDoesNotAcceptNullParameter;

- (void)delegatedMethodDoesNotExistOnDelegateWithJavaLangReflectMethod:(JavaLangReflectMethod *)mockMethod
                                                                withId:(id)mock
                                                                withId:(id)delegate;

- (void)delegatedMethodHasWrongReturnTypeWithJavaLangReflectMethod:(JavaLangReflectMethod *)mockMethod
...
- (void)serializableWontWorkForObjectsThatDontImplementSerializableWithIOSClass:(IOSClass *)classToMock;
...
- (void)usingConstructorWithFancySerializableWithOrgMockitoMockSerializableMode:(OrgMockitoMockSerializableMode *)mode;
