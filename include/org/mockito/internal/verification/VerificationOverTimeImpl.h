...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/testing/mockito/build_result/java/org/mockito/internal/verification/VerificationOverTimeImpl.java
//
...
FOUNDATION_EXPORT void OrgMockitoInternalVerificationVerificationOverTimeImpl_initWithLong_withLong_withOrgMockitoVerificationVerificationMode_withBoolean_withOrgMockitoInternalUtilTimer_(OrgMockitoInternalVerificationVerificationOverTimeImpl *self, jlong pollingPeriodMillis, jlong durationMillis, id<OrgMockitoVerificationVerificationMode> delegate, jboolean returnOnSuccess, OrgMockitoInternalUtilTimer *timer);

FOUNDATION_EXPORT OrgMockitoInternalVerificationVerificationOverTimeImpl *new_OrgMockitoInternalVerificationVerificationOverTimeImpl_initWithLong_withLong_withOrgMockitoVerificationVerificationMode_withBoolean_withOrgMockitoInternalUtilTimer_(jlong pollingPeriodMillis, jlong durationMillis, id<OrgMockitoVerificationVerificationMode> delegate, jboolean returnOnSuccess, OrgMockitoInternalUtilTimer *timer) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalVerificationVerificationOverTimeImpl *create_OrgMockitoInternalVerificationVerificationOverTimeImpl_initWithLong_withLong_withOrgMockitoVerificationVerificationMode_withBoolean_withOrgMockitoInternalUtilTimer_(jlong pollingPeriodMillis, jlong durationMillis, id<OrgMockitoVerificationVerificationMode> delegate, jboolean returnOnSuccess, OrgMockitoInternalUtilTimer *timer);
