...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/testing/mockito/build_result/java/org/mockito/MockSettings.java
//
...
@endcode
 ...
 @since 1.10.12
 */
- (id<OrgMockitoMockSettings>)useConstructor;

/*!
 @brief Makes it possible to mock non-static inner classes in conjunction with <code>useConstructor()</code>.
 <p>
  Example: 
 <pre class="code"><code class="java">
