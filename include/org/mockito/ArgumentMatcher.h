...
/*!
 @brief By default this method decamelizes matchers name to promote meaningful names for matchers.
 <p>
 ...
 @param description_ the description to which the matcher description is  appended.
 */
