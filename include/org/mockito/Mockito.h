...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/testing/mockito/build_result/java/org/mockito/Mockito.java
//
...
/*!
 @brief Allows verifying over a given period.It causes a verify to wait for a specified period of time for a desired
  interaction rather than failing immediately if has not already happened.
 May be useful for testing in concurrent
  conditions. 
 <p>
  This differs from <code>timeout()</code> in that after() will wait the full period, whereas timeout()
 ...
 */
+ (id<OrgMockitoVerificationVerificationAfterDelay>)afterWithInt:(jint)millis;
...
/*!
 ...
 <p>
  ...
  See also <code>MockSettings.useConstructor()</code>.
  <p>
  Examples: 
 <pre class="code"><code class="java">
...
/*!
 @brief Allows verifying with timeout.It causes a verify to wait for a specified period of time for a desired
  interaction rather than fails immediately if has not already happened.
 May be useful for testing in concurrent
  conditions. 
 <p>
  This differs from <code>after()</code> in that after() will wait the full period, unless
...
FOUNDATION_EXPORT id<OrgMockitoVerificationVerificationAfterDelay> OrgMockitoMockito_afterWithInt_(jint millis);
