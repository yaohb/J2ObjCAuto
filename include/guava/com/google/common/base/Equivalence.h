...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/build_result/java/com/google/common/base/Equivalence.java
//
...
- (jboolean)testWithId:(id)t
                withId:(id)u __attribute__((deprecated));
