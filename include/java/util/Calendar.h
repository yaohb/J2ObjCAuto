 ...
 */
+ (id<JavaUtilSet>)getAvailableCalendarTypes;
...
/*!
 ...
 - seealso: Calendar#set(int, int)
 */
- (JavaUtilCalendar_Builder *)setWithInt:(jint)field
                                 withInt:(jint)value;
 ...
 */
- (JavaUtilCalendar_Builder *)setCalendarTypeWithNSString:(NSString *)type;
...
@endcode
 ...
 @return this <code>Calendar.Builder</code>
 */
- (JavaUtilCalendar_Builder *)setDateWithInt:(jint)year
                                     withInt:(jint)month
 ...
 */
- (JavaUtilCalendar_Builder *)setFieldsWithIntArray:(IOSIntArray *)fieldValuePairs;
 ...
 */
- (JavaUtilCalendar_Builder *)setInstantWithJavaUtilDate:(JavaUtilDate *)instant;
...
/*!
 ...
 - seealso: Calendar#time
 */
- (JavaUtilCalendar_Builder *)setInstantWithLong:(jlong)instant;
 ...
 */
- (JavaUtilCalendar_Builder *)setLenientWithBoolean:(jboolean)lenient;
 ...
 */
- (JavaUtilCalendar_Builder *)setLocaleWithJavaUtilLocale:(JavaUtilLocale *)locale;
...
@endcode
 ...
 @return this <code>Calendar.Builder</code>
 */
- (JavaUtilCalendar_Builder *)setTimeOfDayWithInt:(jint)hourOfDay
                                          withInt:(jint)minute
                                          withInt:(jint)second;
 ...
 */
- (JavaUtilCalendar_Builder *)setTimeZoneWithJavaUtilTimeZone:(JavaUtilTimeZone *)zone;
 ...
 */
- (JavaUtilCalendar_Builder *)setWeekDateWithInt:(jint)weekYear
                                         withInt:(jint)weekOfYear
                                         withInt:(jint)dayOfWeek;
 ...
 */
- (JavaUtilCalendar_Builder *)setWeekDefinitionWithInt:(jint)firstDayOfWeek
