...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/io/Files.java
//
...
+ (void)appendWithJavaLangCharSequence:(id<JavaLangCharSequence>)from
             ...
             withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset __attribute__((deprecated));
...
+ (void)copy__WithJavaIoFile:(JavaIoFile *)from
   withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset
      withJavaLangAppendable:(id<JavaLangAppendable>)to OBJC_METHOD_FAMILY_NONE __attribute__((deprecated));
...
+ (ComGoogleCommonHashHashCode *)hash__WithJavaIoFile:(JavaIoFile *)file
                  withComGoogleCommonHashHashFunction:(id<ComGoogleCommonHashHashFunction>)hashFunction __attribute__((deprecated));
...
withComGoogleCommonIoByteProcessor:(id<ComGoogleCommonIoByteProcessor>)processor __attribute__((deprecated));
...
+ (id)readLinesWithJavaIoFile:(JavaIoFile *)file
    withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset
withComGoogleCommonIoLineProcessor:(id<ComGoogleCommonIoLineProcessor>)callback __attribute__((deprecated));
