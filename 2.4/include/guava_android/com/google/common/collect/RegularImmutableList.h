...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/RegularImmutableList.java
//
...
FOUNDATION_EXPORT void ComGoogleCommonCollectRegularImmutableList_initWithNSObjectArray_withInt_(ComGoogleCommonCollectRegularImmutableList *self, IOSObjectArray *array, jint size);

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableList *new_ComGoogleCommonCollectRegularImmutableList_initWithNSObjectArray_withInt_(IOSObjectArray *array, jint size) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableList *create_ComGoogleCommonCollectRegularImmutableList_initWithNSObjectArray_withInt_(IOSObjectArray *array, jint size);
