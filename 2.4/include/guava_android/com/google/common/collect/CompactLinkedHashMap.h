...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/CompactLinkedHashMap.java
//
...
FOUNDATION_EXPORT void ComGoogleCommonCollectCompactLinkedHashMap_init(ComGoogleCommonCollectCompactLinkedHashMap *self);

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashMap *new_ComGoogleCommonCollectCompactLinkedHashMap_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashMap *create_ComGoogleCommonCollectCompactLinkedHashMap_init(void);

FOUNDATION_EXPORT void ComGoogleCommonCollectCompactLinkedHashMap_initWithInt_(ComGoogleCommonCollectCompactLinkedHashMap *self, jint expectedSize);

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashMap *new_ComGoogleCommonCollectCompactLinkedHashMap_initWithInt_(jint expectedSize) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashMap *create_ComGoogleCommonCollectCompactLinkedHashMap_initWithInt_(jint expectedSize);

FOUNDATION_EXPORT void ComGoogleCommonCollectCompactLinkedHashMap_initWithInt_withFloat_withBoolean_(ComGoogleCommonCollectCompactLinkedHashMap *self, jint expectedSize, jfloat loadFactor, jboolean accessOrder);

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashMap *new_ComGoogleCommonCollectCompactLinkedHashMap_initWithInt_withFloat_withBoolean_(jint expectedSize, jfloat loadFactor, jboolean accessOrder) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCompactLinkedHashMap *create_ComGoogleCommonCollectCompactLinkedHashMap_initWithInt_withFloat_withBoolean_(jint expectedSize, jfloat loadFactor, jboolean accessOrder);
