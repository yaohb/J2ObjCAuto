...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/RegularImmutableSet.java
//
...
FOUNDATION_EXPORT void ComGoogleCommonCollectRegularImmutableSet_initWithNSObjectArray_withInt_withNSObjectArray_withInt_withInt_(ComGoogleCommonCollectRegularImmutableSet *self, IOSObjectArray *elements, jint hashCode, IOSObjectArray *table, jint mask, jint size);

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableSet *new_ComGoogleCommonCollectRegularImmutableSet_initWithNSObjectArray_withInt_withNSObjectArray_withInt_withInt_(IOSObjectArray *elements, jint hashCode, IOSObjectArray *table, jint mask, jint size) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableSet *create_ComGoogleCommonCollectRegularImmutableSet_initWithNSObjectArray_withInt_withNSObjectArray_withInt_withInt_(IOSObjectArray *elements, jint hashCode, IOSObjectArray *table, jint mask, jint size);
