...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/RegularImmutableMultiset.java
//
...
- (instancetype __nonnull)initWithComGoogleCommonCollectObjectCountHashMap:(ComGoogleCommonCollectObjectCountHashMap *)contents;
...
FOUNDATION_EXPORT void ComGoogleCommonCollectRegularImmutableMultiset_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectRegularImmutableMultiset *self, ComGoogleCommonCollectObjectCountHashMap *contents);

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableMultiset *new_ComGoogleCommonCollectRegularImmutableMultiset_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountHashMap *contents) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectRegularImmutableMultiset *create_ComGoogleCommonCollectRegularImmutableMultiset_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountHashMap *contents);
