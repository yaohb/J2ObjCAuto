...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/ObjectCountHashMap.java
//
...
FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountHashMap_init(ComGoogleCommonCollectObjectCountHashMap *self);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *new_ComGoogleCommonCollectObjectCountHashMap_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *create_ComGoogleCommonCollectObjectCountHashMap_init(void);

FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountHashMap_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountHashMap *self, ComGoogleCommonCollectObjectCountHashMap *map);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *new_ComGoogleCommonCollectObjectCountHashMap_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountHashMap *map) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *create_ComGoogleCommonCollectObjectCountHashMap_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountHashMap *map);

FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountHashMap_initWithInt_(ComGoogleCommonCollectObjectCountHashMap *self, jint capacity);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *new_ComGoogleCommonCollectObjectCountHashMap_initWithInt_(jint capacity) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *create_ComGoogleCommonCollectObjectCountHashMap_initWithInt_(jint capacity);

FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountHashMap_initWithInt_withFloat_(ComGoogleCommonCollectObjectCountHashMap *self, jint expectedSize, jfloat loadFactor);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *new_ComGoogleCommonCollectObjectCountHashMap_initWithInt_withFloat_(jint expectedSize, jfloat loadFactor) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountHashMap *create_ComGoogleCommonCollectObjectCountHashMap_initWithInt_withFloat_(jint expectedSize, jfloat loadFactor);
...
- (instancetype __nonnull)initWithComGoogleCommonCollectObjectCountHashMap:(ComGoogleCommonCollectObjectCountHashMap *)outer$
                                                                   withInt:(jint)index;
