...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/CompactHashSet.java
//
...
FOUNDATION_EXPORT void ComGoogleCommonCollectCompactHashSet_init(ComGoogleCommonCollectCompactHashSet *self);

FOUNDATION_EXPORT ComGoogleCommonCollectCompactHashSet *new_ComGoogleCommonCollectCompactHashSet_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCompactHashSet *create_ComGoogleCommonCollectCompactHashSet_init(void);

FOUNDATION_EXPORT void ComGoogleCommonCollectCompactHashSet_initWithInt_(ComGoogleCommonCollectCompactHashSet *self, jint expectedSize);

FOUNDATION_EXPORT ComGoogleCommonCollectCompactHashSet *new_ComGoogleCommonCollectCompactHashSet_initWithInt_(jint expectedSize) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCompactHashSet *create_ComGoogleCommonCollectCompactHashSet_initWithInt_(jint expectedSize);
