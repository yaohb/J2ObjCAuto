...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/collect/ObjectCountLinkedHashMap.java
//
...
- (instancetype __nonnull)initWithComGoogleCommonCollectObjectCountHashMap:(ComGoogleCommonCollectObjectCountHashMap *)map;
...
FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountLinkedHashMap_init(ComGoogleCommonCollectObjectCountLinkedHashMap *self);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *new_ComGoogleCommonCollectObjectCountLinkedHashMap_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *create_ComGoogleCommonCollectObjectCountLinkedHashMap_init(void);

FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountLinkedHashMap_initWithInt_(ComGoogleCommonCollectObjectCountLinkedHashMap *self, jint expectedSize);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *new_ComGoogleCommonCollectObjectCountLinkedHashMap_initWithInt_(jint expectedSize) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *create_ComGoogleCommonCollectObjectCountLinkedHashMap_initWithInt_(jint expectedSize);

FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountLinkedHashMap_initWithInt_withFloat_(ComGoogleCommonCollectObjectCountLinkedHashMap *self, jint expectedSize, jfloat loadFactor);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *new_ComGoogleCommonCollectObjectCountLinkedHashMap_initWithInt_withFloat_(jint expectedSize, jfloat loadFactor) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *create_ComGoogleCommonCollectObjectCountLinkedHashMap_initWithInt_withFloat_(jint expectedSize, jfloat loadFactor);

FOUNDATION_EXPORT void ComGoogleCommonCollectObjectCountLinkedHashMap_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountLinkedHashMap *self, ComGoogleCommonCollectObjectCountHashMap *map);

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *new_ComGoogleCommonCollectObjectCountLinkedHashMap_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountHashMap *map) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectObjectCountLinkedHashMap *create_ComGoogleCommonCollectObjectCountLinkedHashMap_initWithComGoogleCommonCollectObjectCountHashMap_(ComGoogleCommonCollectObjectCountHashMap *map);
