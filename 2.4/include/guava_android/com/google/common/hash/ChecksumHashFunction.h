...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/guava/android/build_result/java/com/google/common/hash/ChecksumHashFunction.java
//
...
- (instancetype __nonnull)initWithComGoogleCommonHashImmutableSupplier:(id<ComGoogleCommonHashImmutableSupplier>)checksumSupplier
                                                               withInt:(jint)bits
...
FOUNDATION_EXPORT void ComGoogleCommonHashChecksumHashFunction_initWithComGoogleCommonHashImmutableSupplier_withInt_withNSString_(ComGoogleCommonHashChecksumHashFunction *self, id<ComGoogleCommonHashImmutableSupplier> checksumSupplier, jint bits, NSString *toString);

FOUNDATION_EXPORT ComGoogleCommonHashChecksumHashFunction *new_ComGoogleCommonHashChecksumHashFunction_initWithComGoogleCommonHashImmutableSupplier_withInt_withNSString_(id<ComGoogleCommonHashImmutableSupplier> checksumSupplier, jint bits, NSString *toString) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonHashChecksumHashFunction *create_ComGoogleCommonHashChecksumHashFunction_initWithComGoogleCommonHashImmutableSupplier_withInt_withNSString_(id<ComGoogleCommonHashImmutableSupplier> checksumSupplier, jint bits, NSString *toString);
