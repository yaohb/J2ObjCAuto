...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/testing/mockito/build_result/java/org/mockito/internal/stubbing/InvocationContainerImpl.java
//
...
- (instancetype __nonnull)initWithOrgMockitoInternalProgressMockingProgress:(id<OrgMockitoInternalProgressMockingProgress>)mockingProgress
...
FOUNDATION_EXPORT void OrgMockitoInternalStubbingInvocationContainerImpl_initWithOrgMockitoInternalProgressMockingProgress_withOrgMockitoMockMockCreationSettings_(OrgMockitoInternalStubbingInvocationContainerImpl *self, id<OrgMockitoInternalProgressMockingProgress> mockingProgress, id<OrgMockitoMockMockCreationSettings> mockSettings);

FOUNDATION_EXPORT OrgMockitoInternalStubbingInvocationContainerImpl *new_OrgMockitoInternalStubbingInvocationContainerImpl_initWithOrgMockitoInternalProgressMockingProgress_withOrgMockitoMockMockCreationSettings_(id<OrgMockitoInternalProgressMockingProgress> mockingProgress, id<OrgMockitoMockMockCreationSettings> mockSettings) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalStubbingInvocationContainerImpl *create_OrgMockitoInternalStubbingInvocationContainerImpl_initWithOrgMockitoInternalProgressMockingProgress_withOrgMockitoMockMockCreationSettings_(id<OrgMockitoInternalProgressMockingProgress> mockingProgress, id<OrgMockitoMockMockCreationSettings> mockSettings);
