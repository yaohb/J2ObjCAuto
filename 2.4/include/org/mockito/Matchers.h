...
//  source: /Users/antoniocortes/j2objcprj/relases/j2objc/testing/mockito/build_result/java/org/mockito/Matchers.java
//
...
/*!
 ...
 <p>
  ...
  <p>
  This method <b>
 *doesn't do any type checks*</b>, it is only there to avoid casting in your code. This might however change (type checks could be added) in a future major release. <p> See examples in javadoc for <code>Matchers</code> class
...
/*!
 ...
 <p>
  This method <b>
 *doesn't do any type checks*</b>, it is only there to avoid casting in your code. This might however change (type checks could be added) in a future major release. <p> Has aliases: <code>any()</code> and <code>any(Class clazz)</code> <p> See examples in javadoc for <code>Matchers</code> class
 @return <code>null</code>.
 */
+ (id)anyObject;
...
/*!
 ...
 <p>
  ...
  <p>
  This method <b>
 *dones't do any type checks*</b>, it is only there to avoid casting in your code. This might however change (type checks could be added) in a future major release. <p> See examples in javadoc for <code>Matchers</code> class
